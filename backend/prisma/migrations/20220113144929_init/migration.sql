...
CREATE TABLE "Driver" (
    ...
    "key_focus_area" TEXT,
    "fico" TEXT,
    "seatbelt_and_speeding" TEXT,
    "seatbelt_off_rate" TEXT,
    "speeding_event_rate" TEXT,
    "distractions_rate" TEXT,
    "following_distance_rate" TEXT,
    "signal_violations_rate" TEXT,
    "delivery_completion_rate" TEXT,
    "delivered_and_recieved" INTEGER,
    "photo_on_delivery" TEXT,
    "call_compliance" TEXT,
    "scan_compliance" TEXT,
    "attended_delivery_accuracy" INTEGER,
    "dnr" INTEGER,
    "pod_opps" INTEGER,
    "cc_opps" INTEGER,
    "netradyne" INTEGER,
